...
def generate_msr_plots(df):
    ...
    plt.title('RQ2: Usage Domain (path-token inference, not validated architectural analysis)', fontweight='bold', pad=15)
    plt.figtext(0.5, -0.02, "*usage_domain is inferred from file-path tokens, not from a validated architectural analysis.", ha="center", fontsize=9, bbox={"facecolor": "orange", "alpha": 0.2, "pad": 5})
    ...
    plt.title('RQ4: Algorithm Distribution by Technology Generation (Legacy vs. Modern)', fontweight='bold', pad=15)
